...
def test():
    ...
    my_user_scoring = UserScoring.UserScoring(**params)

    my_user_scoring.set_snowflake_connection(snowflake_secret_name)   

    my_user_scoring.set_params(iteration=750)
    print(my_user_scoring._iteration)
    #my_user_scoring.run_user_scoring()

    # myUserScoring.push_to_TTD(ttd_user, ADVERTISER_ID, "TEST_UserScoring1", secret_key)
